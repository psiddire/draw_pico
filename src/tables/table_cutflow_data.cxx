...
int main(){
  ...
  string foldersig(bfolder+"zgamma_data/2016/data/pico/*");
  ...
  // auto proc_el_sig = Process::MakeShared<Baby_pico>("Sig e",  Process::Type::data, kBlack, {foldersig+"EG*.root"}, "1");
  auto proc_el_sig = Process::MakeShared<Baby_pico>("Sig e",  Process::Type::data, kBlack, {foldersig+"*DoubleEG*.root"}, "1");
  auto proc_mu_sig = Process::MakeShared<Baby_pico>("#rm{Sig}#; #mu",Process::Type::data, kBlack, {foldersig+"*DoubleMuon*.root"}, "1");
