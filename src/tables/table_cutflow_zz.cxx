...
int main(){
  ...
  string foldersig(bfolder+"zgamma_zz/2017/zz/unskimmed/*");
  ...
  auto proc_el_sig = Process::MakeShared<Baby_pico>("Electron Channel",  Process::Type::signal, kMagenta-4, {foldersig+"*.root"}, (sig_lepid == 2));
  ...
  PlotMaker pm;
  pm.Push<Table>("AN_hzz_cutflow", vector<TableRow>{
