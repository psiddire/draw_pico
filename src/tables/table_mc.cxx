...
int main(){
  ...
  string foldersig(bfolder+"zgamma_mc_ul/2017/mc/unskimmed/*");
  ...
  auto proc_el_sig = Process::MakeShared<Baby_pico>("Sig e",  Process::Type::data, kBlack, {foldersig+"*DYJetsToLL*.root"}, "nel>1" && "stitch_dy");
  auto proc_mu_sig = Process::MakeShared<Baby_pico>("Sig #mu",Process::Type::data, kBlack, {foldersig+"*DYJetsToLL*.root"}, "nmu>1" && "stitch_dy");
  ...
  PlotMaker pm;
  pm.Push<Table>("AN_mc_cutflow", vector<TableRow>{
